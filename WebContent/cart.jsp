                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                             <tr>
                                                ...
                                                <td class="product-name"><a href="#">Bose Headphones</a></td>
                                                <td class="product-price"><span class="amount">$210.00</span></td>
                                                <td class="product-quantity">
                                                    <input value="1" type="number">
                                                </td>
                                                <td class="product-subtotal">$210.00</td>
                                            </tr>
                                             <tr>
                                                <td class="product-remove"><a href="#"><i class="ion-android-close"></i></a></td>
                                                <td class="product-name"><a href="#">Black Hoodie</a></td>
