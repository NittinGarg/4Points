                                ...
                                <div id="checkout-login" class="coupon-content">
                                    <div class="coupon-info">
                                         <form action="Logging">
                                            ...
                                            <p class="form-row">					
                                                <input type="submit" name="checkout" value="Login" />
                                                <label>
                                                    <input type="checkbox" />
                                                     Remember me 
                                                </label>
                            ...
                            <form action="order" method="post">
                                <div class="checkbox-form">						
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">									
                                                <input type="text" name="ASU" placeholder="Apartment, suite, unit etc. (optional)" / required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    Bose Headphones	<strong class="product-quantity"> * 1</strong>
                                                </td>
                                                <td class="product-total">
                                                    <span class="amount">$210.00</span>
                                                </td>
                                            </tr>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    Black Hoodie	<strong class="product-quantity"> * 1</strong>
                                                </td>
                                                <td class="product-total">
                                        ...
                                        <tfoot>
                                          ...
                                          <!--   <tr class="cart-subtotal">
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount">$300.00</span></strong>
                                                </td>
                                            </tr>								
                                        </tfoot>
                                    </table>
                                ...
                                <div class="payment-method">
                                    <div class="payment-accordion">
                                        <div class="panel-group" id="faq">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title"><a class="collapsed" data-toggle="collapse" aria-expanded="false" data-parent="#faq" href="#payment-3">Cash on Delivery</a></h5>
                                                </div>
                                                <div id="payment-3" class="panel-collapse collapse">
                                                    <div class="panel-body">
                                                        <p>Make your payment, When your order is at your doorstep.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="order-button-payment">
                                           <a href="index.jsp"> <input type="submit" value="Place order" /></a>
