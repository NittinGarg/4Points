    ...
    <body>
        ...
        <div class="wrapper">
										...
										int count = 1;
									     	try {
												...
												String imgname = rslt.getString(1);%>
												 <input value="Question <%=count %> : <%=rslt.getString(1)%>"/>
	                                             
												<input type="checkbox" name="opt" value="a"><%=rslt.getString(2)%><br>
												<input type="checkbox" name="opt" value="b"><%=rslt.getString(3) %><br>
												<input type="checkbox" name="opt" value="c"><%=rslt.getString(4) %><br>
												<input type="checkbox" name="opt" value="d"><%=rslt.getString(5) %><br><br>
            ...
            <div class="button-box">
                                                <button type="submit" name="Add1" value="Update" class="default-btn floatright">Submit</button>
